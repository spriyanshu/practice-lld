# Online Auction System - Notes

## 🎯 Key Insights

- Medium difficulty problem
- Focus on Observer pattern and Real-time processing
- Time limit: 35min
...
### Design Patterns
- **Observer pattern**: How to apply this pattern
- **Real-time processing**: How to apply this pattern
