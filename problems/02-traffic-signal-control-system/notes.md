# Traffic Signal Control System - Notes

## 🎯 Key Insights

- Easy difficulty problem
- Focus on State machine design and Event-driven architecture
- Time limit: 25min
...
### Design Patterns
- **State machine design**: How to apply this pattern
- **Event-driven architecture**: How to apply this pattern
