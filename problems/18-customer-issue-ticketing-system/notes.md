# Customer Issue Ticketing System - Notes

## 🎯 Key Insights

- Medium difficulty problem
- Focus on Workflow design and State management
- Time limit: 35min
...
### Design Patterns
- **Workflow design**: How to apply this pattern
- **State management**: How to apply this pattern
